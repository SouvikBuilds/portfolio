    ...
    <section id="contact" className="py-24">
      <div className="max-w-6xl mx-auto px-6">
        <div className="bg-zinc-900 dark:bg-zinc-800 rounded-3xl p-10 md:p-16 relative overflow-hidden">
          <div
            className="absolute top-0 right-0 w-64 h-64 bg-orange-500/20 rounded-full blur-3xl pointer-events-none"
            aria-hidden="true"
          ></div>
          <div
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="reveal d1 font-display font-bold text-4xl md:text-5xl text-white leading-tight mb-5 in">
                Let&apos;s work
                <br />
                together
              </h2>
              <p className="reveal d2 text-zinc-400 leading-relaxed mb-8 in">
                I&apos;m open to frontend and full-stack projects, short or long-term. Landing pages, web apps, interactive interfaces, or complete products — let&apos;s work together.
              </p>

              <div className="reveal d3 flex flex-col gap-4 in">
                <Link
                  href="mailto:csouvik2006@gmail.com"
                ...
                >
                  ...
                  <span className="text-sm">csouvik2006@gmail.com</span>
                </Link>
                <Link
                ...
                >
                  ...
                  <span className="text-sm">
                    linkedin.com/in/souvikbuilds04/
                  </span>
                </Link>
                <a
                ...
                >
                  ...
                  <span className="text-sm">github.com/SouvikBuilds</span>
                </a>
              </div>
            </div>

            <div className="reveal d2 in">
              <form action="#" method="POST" noValidate>
                <div className="flex flex-col gap-4">
                  ...
                  <button
                    type="submit"
                    className="shimmer w-full bg-orange-500 cursor-pointer text-white font-display font-bold text-sm py-3.5 rounded-xl hover:bg-accent-light transition-colors"
                  >
                    Send message →
                  </button>
                </div>
